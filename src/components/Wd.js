                ...
                <div className="col-lg-3">
                    ...
                    <div className="card my-2 w-100">
                        ...
                        <div className="card-body">
                            ...
                            {/* MEDIA OBJECTS */}
                            <div className="media">
                                <img src="craft pics/wall cages/cage1.jpg" className="img-thumbnail mx-auto w-50 "/>
                        ...
                        <div className="card-body">
                            ...
                            {/* MEDIA OBJECTS */}
                            <div className="media">
                                <img src="craft pics/wall cages/hang1.jpg" className="img-thumbnail mx-auto w-50 "/>
                                <div className="media-body mx-3">
                                    <h6> Wall Decors </h6>
                                    <p>
                                        <i className="fas fa-star"></i>
